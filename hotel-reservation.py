...
class Hotel:
    ...
    def Bookingroom(self, requestedRoom):
        if requestedRoom in self.availablerooms:
            print("The room you requested booked for you.")
            self.availablerooms.remove(requestedRoom)
        else:
            print("Sorry the room you have requested is not available")
...
class Customer:
    def requestBooking(self):
        print("Enter the name of the room you like to book>>")
        self.book = input()
        return self.book

    def cancelBooking(self):
        print("Enter the name of the room you like to cancel>>")
        self.book = input()
        return self.book


def main():
    hotel = Hotel(["Single", "Double", "Premium"])
    customer = Customer()
    done = False
    while done == False:
